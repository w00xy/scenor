...
export class WorkflowSharesController {
  ...
  @ApiResponse({ status: 201, description: 'Ссылка для общего доступа успешно создана' })
  ...
  @ApiResponse({ status: 200, description: 'Список ссылок общего доступа успешно получен' })
  @ApiResponse({ status: 401, description: 'Unauthorized - требуется авторизация' })
  ...
  @ApiResponse({ status: 200, description: 'Workflow успешно получен по токену' })
  ...
  @ApiResponse({ status: 200, description: 'Ссылка общего доступа успешно удалена' })
  @ApiResponse({ status: 401, description: 'Unauthorized - требуется авторизация' })
